...
import IconGameAtomic from '@/components/icons/IconGameAtomic.vue'
import IconGameWitcher from '@/components/icons/IconGameWitcher.vue'
import IconGameDiablo from '@/components/icons/IconGameDiablo.vue'
import IconGameDoom from '@/components/icons/IconGameDoom.vue'
